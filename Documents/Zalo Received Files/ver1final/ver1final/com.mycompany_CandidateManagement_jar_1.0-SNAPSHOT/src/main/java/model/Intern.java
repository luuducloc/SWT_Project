...
public class Intern extends Candidate{
    ...
    public Intern(String major, String semester, String university, int id, String fistName, String lastName, int yearOfBirth, String address, String phone, String email, int type, ArrayList<Skill> listSkills) {
